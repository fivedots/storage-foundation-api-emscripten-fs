...
for (var x in SyscallsSyncLibrary) {
  wrapSyscallFunction(x, SyscallsSyncLibrary, false);
}

mergeInto(LibraryManager.library, SyscallsSyncLibrary);
